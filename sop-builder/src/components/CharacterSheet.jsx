...
export default function CharacterSheet({ character, onChange }) {
  ...
  const powerLevels = classLevels.filter((cl) => classesById[cl.classId]?.system === 'power');
  ...
  const practitionerMod = mods.wis ?? 0;
    ...
    <>
      ...
      <div className="card">
        ...
        {mightLevels.length > 0 && (
          <div className="grid-row grid-4" style={{ marginTop: powerLevels.length > 0 ? 14 : 0 }}>
            <div className="stat-box">
              <div className="stat-label">Combat Sphere DC</div>
              <div className="stat-value">{10 + Math.floor(totalBab / 2) + practitionerMod}</div>
              <div className="stat-sub">10 + ½BAB + practitioner mod</div>
            </div>
            <div className="field">
        ...
        {guileLevels.length > 0 && (
          <div className="grid-row grid-4" style={{ marginTop: (powerLevels.length > 0 || mightLevels.length > 0) ? 14 : 0 }}>
            <div className="stat-box">
      ...
      <TalentPicker
        ...
        emptyNote="No Champion class levels yet - add one above to gain combat talents."
      />
